...
if ( ! defined('BBR_LS_version')){
	...
	define("BBR_LS_default_settings", 	"deutsch,de|english,en|turkish,tr");
...
class Bbr_langswitch{
	...
	var $description		= 'Used to change language on the backened based on the path.php settings.';
	...
	* @see __construct()
	*/
	function Bbr_langswitch($settings=array('available_languages' 	=> BBR_LS_default_settings,
											'default_language'		=> BBR_LS_default_language))
	{
	...
	* @since	Version 1.1.0
	*/
	function __construct($settings=array('available_languages' 	=> BBR_LS_default_settings,
										 'default_language'		=> BBR_LS_default_language))
	{
